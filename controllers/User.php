...
class User extends CI_Controller
{
    ...
    // function to search through database and create results
        ...
        if($get_db_name!==null)
        {
            ...
            // {
                ...
                foreach($get_post as $row)
                {
                    ...
                    // else if($parent_post==$row->parent_id)
                    // {
                    //     // 
                    //     $version["id"]=$row->id;
                    //     $version["user_id"]=$row->user_id;
                    ...
                    //     $version["blog_url"]=$row->blog_url;
                    //     $version["content"]=$row->content;
                    //     $version["date_time"]=$row->date_time;
                    //     $this->post_versions[$k]=$version;
                    // }
                    // $k++;
                    // print_r("hello");
	...
	public function get_textarea($blog_id,$num)
	{
        ...
        else
        {
		    ...
		    echo "<textarea name='data' class='selector".$num."' >".$content."</textarea><br><input type='submit' class='btn btn-info' name='save' value='save'>";
        }
		// 
    }
