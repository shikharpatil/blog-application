...
$route['post/save_blog']="post/save_blog";
$route['post/save_as_drafts']="post/save_as_drafts";
$route['post/edit_drafts']="post/edit_drafts";
$route['post/publish_post']="post/publish_post";
$route['(:any)/drafts']='post/get_drafts';
$route['user/logout']="user/logout";
$route['post/upload_image']='post/upload_image';
// $route['user/get_blogs/(:num)']='user/get_blogs/$1';
$route['post/update_blog']='post/update_blog';
$route['search/do_search']='search/do_search';
$route['post/save_comment']="post/save_comment";
$route['post/delete_blog/(:num)']='post/delete_blog/$1';
$route['post/get_versions/(:num)/(:num)']='post/get_versions/$1/$2';
$route['post/get_next_versions/(:num)/(:num)']='post/get_next_versions/$1/$2';
// $route['user/get_textarea/(:num)/(:num)']='user/get_textarea/$1/$2';
// $route['user/logout']='user/logout';
$route['(:any)']='post/check_user/$1';
$route['(:any)/(:any)']='post/open_blog/$1/$2';
